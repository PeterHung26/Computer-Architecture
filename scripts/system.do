...
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/halt
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/flushed
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/ihit
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dhit
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/imemREN
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dmemREN
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dmemWEN
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/imemaddr
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dmemaddr
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/imemload
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/datomic
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dmemload
add wave -noupdate -group {Datapath to Cache} /system_tb/DUT/CPU/dcif/dmemstore
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/iwait
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/dwait
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/iREN
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/dREN
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/dWEN
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/iload
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/dload
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/dstore
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/iaddr
add wave -noupdate -group {Cache to RAM} /system_tb/DUT/CPU/cif0/daddr
...
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/cu_halt
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/cu_Jump
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/ID_JR
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/ID_dread
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/PCSrc
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/EX_dread
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/EX_dwrite
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/ID_rt
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/IF_rs
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/IF_rt
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/IF_EN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/ID_EN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/EX_EN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/MEM_EN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/IF_FLUSH
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/ID_FLUSH
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/EX_FLUSH
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/MEM_FLUSH
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/PC_EN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/iREN
add wave -noupdate -expand -group {Hazard Unit} /system_tb/DUT/CPU/DP/huif/pr_halt
...
update
WaveRestoreZoom {0 ps} {1140781 ps}
